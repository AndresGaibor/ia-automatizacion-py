#!/bin/bash
#
# Release Automático - Acumba Automation
#
...
#
# Argumentos:
#   patch       Incrementa versión patch (v2.18.0 → v2.18.1) [por defecto]
#   minor       Incrementa versión minor (v2.18.0 → v2.19.0)
#   major       Incrementa versión major (v2.18.0 → v3.0.0)
#
# Opciones:
...
ALLOW_DIRTY=false
TAG_MESSAGE=""
REPO_URL="https://github.com/AndresGaibor/ia-automatizacion-py"
...
print_header "🚀 Release Automático - Acumba Automation"
