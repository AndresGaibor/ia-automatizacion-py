...
from src.infrastructure.scraping.models.suscriptores import DatosTablaSuscriptor
...
class ComponenteFilaSuscriptor:
    ...
    def extract_table_data(self) -> DatosTablaSuscriptor:
        ...
        return DatosTablaSuscriptor(correo=correo, lista=lista, estado=estado, calidad=calidad)
